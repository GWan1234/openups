...
.tip-bar.has-tips{display:flex;align-items:flex-start;max-height:200px;padding:8px 20px;background:linear-gradient(135deg,#fffbe6 0%,#fff7cc 100%);border-bottom:1px solid #ffe58f}
.tip-list{display:flex;flex-direction:column;gap:4px;flex:1}
.tip-close{background:none;border:none;cursor:pointer;font-size:16px;color:#8c6e00;padding:0 4px;line-height:1;flex-shrink:0;opacity:.6;transition:opacity .2s}
