...
v2没有用开发板，就没有那个gpio48的rgb灯，把gpio47 gpio48换成了i2c的slave，也加了上拉。温度与湿度（替换为比如说主板温度）通过这个i2c slave发给米家温湿度计，从而接入米家。
...
//外壳已经做好了，后盖有两种，一个是没有pcb板，直接电池夹放上去的，另一个是有pcb板的。仔细看看就能看出来。电池有条件的永远还是推荐直接点焊成组，不用电池夹，电池夹是属于没有这个条件的次选。

v2用4层板的那个，6层板纯属浪费（6层板也不再更新了，没有实际意义），是因为领错了券，对不起嘉立创。